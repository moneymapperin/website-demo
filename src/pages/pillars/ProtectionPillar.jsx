...
export default function ProtectionPillar() {
  ...
  const d = data.pillars?.protection
  if (!d) return <div className="py-20 text-center">Pillar data not found.</div>

  return (
    <PillarLayout
      title={d.title || 'Protection'}
      headerColor={d.headerColor || '#10B981'}
      scoreRing={<ScoreGauge score={d.score || 0} size={160} />}
    >
      <Card>
        <h2 className="mb-4 font-bold text-text-primary">Protection Factors</h2>
